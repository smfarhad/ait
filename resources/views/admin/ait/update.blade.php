                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="circleOfDeductionAuthority" class="form-control select2m" required>
                                                ...
                                                <option value="{{$row->id}}" @if($show->office_id == $row->id) {{'selected'}} @endif >{{$row->name}}</option>
                                                @endforeach
                                                @endif
                                            </select> 
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input name="deductionAuthority" value="{{ucwords(str_replace ('-', ' ',$show->deduction_authority))}}" class="form-control" id="deductionAuthority" placeholder="Deduction Authority" type="text" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="tin" class="col-sm-4 control-label">TIN Of Deducting Authority</label>
                                        <div class="col-sm-8">
                                            <input name="tin" value="{{$show->tin}}" class="form-control" id="Tin" placeholder="TIN Of Beneficiary" data-inputmask="'mask': ['9999-9999-9999']" data-mask type="text" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="head" class="form-control select2m" required>
                                                ...
                                                <option value="{{$row->id}}" @if($show->head_id == $row->id) {{'selected'}} @endif>{{$row->name}}</option>
                                                @endforeach
                                                @endif
                                            </select> 
                                        </div>
...
<!--                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input name="chalanNo" value="{{$show->chalan_no}}" class="form-control" id="chalanNo" placeholder="chalanNo" type="text" required>
                                        </div>
                                    </div>                           -->
                                    <div class="form-group">
                                        <label for="chalanDate" class="col-sm-4 control-label">Chalan Date</label>
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                <div class="input-group-addon">
                                                    <i class="fa fa-calendar"></i>
                                                </div>
                                                <input name="chalanDate" value="{{date('d-m-Y',strtotime($show->chalan_date))}}" class="form-control" id="chalanDate" data-inputmask="'alias': 'dd-mm-yyyy'" data-mask placeholder="-mm-yyyy" type="text" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input name="amount" value="{{$show->amount}}" class="form-control" id="amount" placeholder="Amount" type="text" required>
                                        </div>
                                    </div>
...
<!--                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <select id="branch" name="branch" class="form-control" >
                                                ...
                                                <option data-bank="{{$row->bank_id}}"  value="{{$row->id}}" @if($show->branch_id == $row->id) {{'selected'}} @endif>{{$row->name}}</option>
                                                @endforeach
                                                @endif
                                            </select> 
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="paymentCode" class="form-control select2m">
                                                ...
                                                <option value="{{$row->id}}" @if($show->payment_code == $row->id) {{'selected'}} @endif>{{$row->name}}</option>
                                                @endforeach
                                                @endif
                                            </select> 
                                        </div>
