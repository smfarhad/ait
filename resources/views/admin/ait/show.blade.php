                ...
                <div class="box box-success">
                    ...
                    <div class="box-body">
                        ...
                        <div class="box-body">
                            <div class="row">
                                    <div class="col-md-12">
                                        <label for="name" class="col-sm-3 control-label">Head</label>
                                        <div class="col-sm-5">
                                            {{ $show->head_name }}
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <label for="tin" class="col-sm-3 control-label">Amount</label>
                                        <div class="col-sm-5">
                                            {{ $show->amount }}
                                        </div>
                                    </div>                                
                                    <div class="col-md-12">
                                        <label for="tin" class="col-sm-3 control-label">Chanlan No </label>
                                        <div class="col-sm-5">
                                            {{ $show->chalan_no }}
                                        </div>
                                    </div>                                  
                                    <div class="col-md-12">
                                        <label for="tin" class="col-sm-3 control-label">Chanlan Date </label>
                                        <div class="col-sm-5">
                                            {{ date("d/m/Y", strtotime($show->chalan_date)) }}
                                        </div>
                                    </div>                                    
                                    <div class="col-md-12">
                                        <label for="tin" class="col-sm-3 control-label">Bank Name </label>
                                        <div class="col-sm-5">
                                            {{ $show->bank_name }}
                                        </div>
                                    </div>                                   
                                    <div class="col-md-12">
                                        <label for="tin" class="col-sm-3 control-label">Branch Name </label>
                                        <div class="col-sm-5">
                                            {{ $show->branch_name }}
                                        </div>
                                    </div> 
                                    <div class="col-md-12">
                                        <label for="tin" class="col-sm-3 control-label">Payment Code </label>
                                        <div class="col-sm-5">
                                            {{ $show->payment_code  }}
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <label for="comments" class="col-sm-3 control-label"> Create By </label>
                                        <div class="col-sm-5">
                                            {{$show->created_by_name}}
