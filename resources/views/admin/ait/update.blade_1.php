                    ...
                    <div class="box-body">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <div class="input-group">
                                        ...
                                        <input name="chalanDate" value="{{$show->chalan_date}}" class="form-control" id="chalanDate" data-inputmask="'alias': 'yyyy-mm-dd'" data-mask placeholder="YYYY-MM-DD" type="text" required>
                                      </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <label for="branchName" class="col-sm-2 control-label">Branch Name</label>
                                 <div class="col-sm-4">
                                    <select name="branch" class="form-control select2m">
                                        ...
                                        <option value="{{$row->id}}" @if($show->branch_id == $row->id) {{'selected'}} @endif>{{$row->name}}</option>
                                        @endforeach
                                        @endif
                                    </select> 
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input name="paymentCode" value="{{ $show->payment_code_name }}" class="form-control" id="paymentCode" placeholder="paymentCode" type="text" required>
                                </div>
                            </div> 
