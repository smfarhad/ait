                        ...
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label for="head" class="col-sm-4 control-label">Head Of TDS</label>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                ...
                                                <input name="chalanDate" value="{{date('d-m-Y',strtotime($show->chalan_date))}}" class="form-control" id="chalanDate" data-inputmask="'alias': 'dd-mm-yyyy'" data-mask placeholder="dd-mm-yyyy" type="text" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="head" class="col-sm-4 control-label">Status</label>
                                        <div class="col-sm-7">
