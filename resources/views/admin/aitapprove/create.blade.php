                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label for="deductionAuthority" class="col-sm-4 control-label">Deduction Authority</label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                        <label for="tin" class="col-sm-4 control-label">TIN Of Beneficiary</label>
                                        <div class="col-sm-8">
                                            <input name="tin" value="" class="form-control" id="Tin" placeholder="TIN Of Beneficiary" data-inputmask="'mask': ['9999-9999-9999']" data-mask type="text" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="head" class="col-sm-4 control-label">Circle of Deduction Authority</label>
                                        <div class="col-sm-7">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                ...
                                                <input name="chalanDate" value="" class="form-control" id="chalanDate" data-inputmask="'alias': 'yyyy-mm-dd'" data-mask placeholder="yyyy-mm-dd" type="text" required>
                                            </div>
                                        </div>
                                    </div>
