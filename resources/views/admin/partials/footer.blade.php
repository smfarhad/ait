...
<script src="{{URL::asset('assets/admin/plugins/datatables/dataTables.buttons.min.js')}}"></script>
<script src="{{URL::asset('assets/admin/plugins/datatables/buttons.print.min.js')}}"></script>
<script src="{{URL::asset('assets/admin/plugins/datatables/jszip.min.js')}}"></script>
<script src="{{URL::asset('assets/admin/plugins/datatables/pdfmake.min.js')}}"></script>
<script src="{{URL::asset('assets/admin/plugins/datatables/vfs_fonts.js')}}"></script>
<script src="{{URL::asset('assets/admin/plugins/datatables/buttons.html5.min.js')}}"></script>
...
<!-- Select Plugin Js -->
<script src="{{URL::asset('assets/admin/plugins/select2/select2.js')}}"></script>
