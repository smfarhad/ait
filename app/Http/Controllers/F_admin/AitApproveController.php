...
class AitApproveController extends Controller {
    ...
    public function index() {
        ...
        return view('admin/aitapprove/index')->with('data', $data)->with('disc_list', 1)->with('access', $this->filter());
    }
    ...
    public function create() {
        ...
        return view('admin/aitapprove/create')->with('data', $data);
    }
    ...
    public function store(Request $request) {
        ...
        $input['name_of_beneficiary'] = $request->input('nameOfBeneficiary');
    ...
    public function update(Request $request, $id) {
        ...
        return redirect('/admin/aitapprove');
